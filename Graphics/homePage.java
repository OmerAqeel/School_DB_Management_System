...
public class homePage {
	...
	public homePage() {
		...
		studentBtn.setFont(new Font("Lucida Grande", Font.BOLD | Font.ITALIC, 13));
		...
		teacherBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				teacherHandlePage.open();
				frmHome.dispose();
			}
		});
		teacherBtn.setFont(new Font("Lucida Grande", Font.BOLD | Font.ITALIC, 13));
