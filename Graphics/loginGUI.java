...
public class loginGUI implements ActionListener {
	...
	public void initialize() {
		...
		lblNewLabel.setBounds(73, 62, 97, 16);
		...
		lblNewLabel_3 = new JLabel("Welcome to School Database management.");
		lblNewLabel_3.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		lblNewLabel_3.setBounds(73, 6, 350, 16);
		frmSchoolManagmentSystem.getContentPane().add(lblNewLabel_3);
